...
# Description: Defines the replicatePlotter.M9() function for the TRG drug-combination analysis workflow.
# Source: Extracted from serialPlotter_384.R, lines 1311-1357.

replicatePlotter.M9 <- function(whereIsFileLocated, well, header="", legend=F, plRep=T, repToPick = 2) {
  ...
  plot(x = myFilesLocated[[1]]$Time, y = myFilesLocated[[1]][[well]], 
       xlim = c(1,24), ylim = c(0,0.8), type = 'l', xlab = 'Time', ylab = 'OD600',
